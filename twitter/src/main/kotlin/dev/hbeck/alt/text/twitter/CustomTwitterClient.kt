 ...
 */
class CustomTwitterClient @Inject constructor(
    credRetriever: TwitterCredRetriever,
    configuration: TwitterConfiguration
): CacheLoader<String, User?>(), TwitterClient {
    ...
    override fun usernameToUserId(username: String): User? {
    ...
    override fun getUserTweets(userId: String): List<Tweet>? {
        return sendRequest(
